...
<section class="portfolio" id="portfolio">
    <div class="container-fluid">
        <div class="row">
            ...
            <div align="center">
                <button class="filter-button" data-filter="all">글쓰기</button>
                <img src="file:///C:/Users/bit-user/Desktop/BeginVegan/BeginVegan/resources/img/3.jpg" alt="안나와요"/>
            </div><br/>

            <c:forEach items="${ dietList }" var="diet">
                <div class="gallery_product col-sm-3 col-xs-6 filter category1"
                     onclick="doAction(${diet.id})" id="${diet.id}">
                    <img class="img-responsive" alt="" src="C:\Users\bit-user\Desktop\BeginVegan\BeginVegan\${diet.image}"
