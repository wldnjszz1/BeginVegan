...
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css" href="resources/boardTemplate/fonts/font-awesome-4.7.0/css/font-awesome.min.css">
<!--===============================================================================================-->
    ...
    <div class="limiter">
        <div class="container-table100">
            <div class="wrap-table100">
                <br>
                <hr>
                <h2 align="center">질문 답변 게시글 조회</h2>
                <hr>
                <br>
                            ...
                            <table>
                                ...
                                <c:forEach items="${ askBoardList }" var="ask">
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column4">${ ask.userId }</td>
